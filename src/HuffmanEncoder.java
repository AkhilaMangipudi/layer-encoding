...
public final class HuffmanEncoder {
	...
	// The underlying output filewriter
	 ...
	 */
	public HuffmanEncoder(FileWriter out) {
		this.fw = out;
	}
	 ...
	 */
	public void write(String symbol) throws IOException {
		if (codeTree == null)
			throw new NullPointerException("Code tree is null");
		String bitString = codeTree.getCode(symbol);
		//System.out.println("bitString to write is " + bitString);
		this.fw.write(bitString);
		if(symbol != "\n") {
